...
@section('content')
    ...
    @php
        ...
        $ariaLabel = 'Kembali ke Manajemen Kategori';
    @endphp
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center gap-4 px-4 sm:px-0">
                ...
                <h1 class="text-2xl font-bold text-gray-800 leading-tight">Tambah Kategori Baru</h1>
            </div>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.categories.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-500 transition" required placeholder="Contoh: Pakaian Pria" autofocus>
                            @error('name')
