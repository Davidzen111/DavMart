...
<body class="bg-slate-50 font-sans antialiased flex flex-col min-h-screen">
    ...
    <nav x-data="{ open: false }" class="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20 gap-2">
                ...
                {{-- KIRI: LOGO (Konsisten dengan Home Logo) --}}
                ...
                <div class="hidden lg:flex flex-grow justify-start ml-8 space-x-2 items-center">
                    ...
                    <a href="{{ route('seller.orders.index') }}" class="py-2 px-3 text-sm font-semibold rounded-lg transition flex items-center gap-2 {{ request()->routeIs('seller.orders.*') ? 'bg-slate-900 text-white shadow-md' : 'text-slate-600 hover:bg-amber-50 hover:text-amber-700' }}">
                        Pesanan
                        @php
                            // Pastikan ini di luar blok Blade nav-link jika layout tidak memiliki data ini
                ...
                <div class="flex items-center gap-4 shrink-0">
                    ...
                    @auth
                        ...
                        <div class="hidden lg:flex items-center gap-4">
                            ...
                            {{-- Tombol Log Out (Menggunakan Amber sebagai aksi kedua) --}}
                    ...
                    @else
                        {{-- Tamu (Dibiarkan Konsisten dengan Home Nav) --}}
        ...
        >
            ...
            <div class="space-y-1 mb-2">
                {{-- Mengganti blue-50 ke amber-50 dan blue-700 ke amber-700 --}}
            ...
            <div class="border-t border-slate-100 pt-2">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('home') }}" class="block px-3 py-2 rounded-lg text-sm font-semibold text-slate-600 hover:bg-slate-50 hover:text-slate-900">Beranda Toko</a>
    ...
    {{-- 2. KONTEN UTAMA --}}
    <main class="flex-grow py-8 bg-slate-50"> {{-- Mengganti bg-gray-50 ke bg-slate-50 --}}
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @yield('content') 
        </div>
    </main>
    ...
    <footer class="bg-white border-t border-slate-200 py-8 mt-auto">
        <div class="max-w-7xl mx-auto px-4 text-center text-slate-500 text-sm"> {{-- Mengganti text-gray-500 ke text-slate-500 --}}
